...
# Parameters
num_trials = 10      # Number of times to repeat for averaging
num_perturbations = 45  # Number of perturbed bits per trial
temperature_range = np.arange(0.001, 12.001, 0.4)
